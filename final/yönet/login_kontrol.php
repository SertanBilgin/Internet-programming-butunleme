        ...
        if($_POST['kadi']!="" && $_POST['sifre']!="")
        {
            ...
            $kullanici->execute(
                ...
                if($kullanici->rowCount()==1)
                {
                    ...
                    $db->query("UPDATE kullanici SET kullanici_sifreunuttum='',
                ...
                else
                {
                    ...
                    $kullanici->execute(
                        ...
                        if($kullanici->rowCount()==1)
                        {
                            ...
                            $db->query("UPDATE kullanici SET kullanici_sifre=kullanici_sifreunuttum, kullanici_sifreunuttum='',kullanici_songiris=NOW()
